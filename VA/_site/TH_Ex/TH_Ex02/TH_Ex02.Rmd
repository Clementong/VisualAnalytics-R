...
g<-combined_pop_grouped_inter_agg_PA%>%
  ...
  labs(title = "Relatively new estates like ", subtitle = "Regions of Singapore Young-Age Dependency Ratio by Planning Area", x="Young Dependency Ratio" , y="Aged Dependency Ratio")
ggplotly(g)

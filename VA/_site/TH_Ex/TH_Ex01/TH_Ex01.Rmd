...
Next, you will use the code chunk below to install and launch [**ggpubr**](https://rpkgs.datanovia.com/ggpubr/) and [**tidyverse**](https://www.tidyverse.org) in RStudio.
...
First, let us import the data into R by using [*read_csv()*](https://readr.tidyverse.org)  of [**readr**](https://readr.tidyverse.org) package.  
